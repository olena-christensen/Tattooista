...
export const metadata: Metadata = {
  ...
  description:
    "The legal terms governing your access to and use of Tattooista's website and services.",
}
...
const LEGAL_EMAIL = "legal@nothingweird.agency"
...
const toc = [
  ...
  { id: "electronic", label: "26. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES" },
  { id: "california", label: "27. CALIFORNIA USERS AND RESIDENTS" },
  { id: "misc", label: "28. MISCELLANEOUS" },
  { id: "contact", label: "29. CONTACT US" },
]

const paymentMethods = ["Visa", "Mastercard", "American Express", "PayPal"]
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <Container className="max-w-[860px] pt-[120px] pb-16 min-[990px]:pt-[140px] min-[990px]:pb-[100px]">
        ...
        <div className="mt-12">
          <h2 className={headingClass}>Agreement to Our Legal Terms</h2>
          <p className={bodyClass}>
            We are {COMPANY}, doing business as{" "}
            <strong className={bold}>Tattooista</strong> (&ldquo;
            <strong className={bold}>Company</strong>,&rdquo; &ldquo;
            <strong className={bold}>we</strong>,&rdquo; &ldquo;
            <strong className={bold}>us</strong>,&rdquo; &ldquo;
            <strong className={bold}>our</strong>&rdquo;), a company registered in Ukraine
            at ave. Voskresenskyi, build 24, housing A, fl. 14, Kyiv, Kyiv 02125.
          </p>
          <p className={bodyClass}>
            ...
            &ldquo;<strong className={bold}>Services</strong>&rdquo;).
          </p>
          <p className={bodyClass}>
            Tattooista is a software-as-a-service platform for tattoo studios. Studios use
            it to launch a branded website, showcase their portfolio, manage client and
            booking information, collect reviews, and create custom content pages. The
            platform is offered on a free tier (ad-supported) and a paid PRO subscription
            that removes advertising and unlocks additional features. Tattooista is
            operated by Nothing Weird, a sole proprietorship registered in Ukraine.
          </p>
          <p className={bodyClass}>
            You can contact us by phone at (+380)776591244, email at{" "}
            <a href={`mailto:${LEGAL_EMAIL}`} className={linkClass}>
              {LEGAL_EMAIL}
            </a>
            , or by mail to ave. Voskresenskyi, build 24, housing A, fl. 14, Kyiv, Kyiv
            02125, Ukraine.
          </p>
          <p className={bodyClass}>
            These Legal Terms constitute a legally binding agreement made between you,
            whether personally or on behalf of an entity (&ldquo;
            <strong className={bold}>you</strong>&rdquo;), and {COMPANY}, concerning your
          ...
          <h2 id="services" className={headingClass}>
            1. Our Services
          </h2>
          <p className={bodyClass}>
          ...
          <h2 id="ip" className={headingClass}>
            2. Intellectual Property Rights
          </h2>
          <h3 className={subheadingClass}>Our intellectual property</h3>
          <p className={bodyClass}>
            ...
            (collectively, the &ldquo;Content&rdquo;), as well as the trademarks, service
            marks, and logos contained therein (the &ldquo;Marks&rdquo;).
          </p>
          <p className={bodyClass}>
          ...
          <p className={bodyClass}>
            The Content and Marks are provided in or through the Services &ldquo;AS IS&rdquo;
            for your internal business purpose only.
          </p>
          <h3 className={subheadingClass}>Your use of our Services</h3>
          <p className={bodyClass}>
            Subject to your compliance with these Legal Terms, including the &ldquo;
            <a href="#prohibited" className={linkClass}>
              PROHIBITED ACTIVITIES
            </a>
            &rdquo; section below, we grant you a non-exclusive, non-transferable, revocable
            license to:
          </p>
          <ul className={listClass}>
            <li className={listItemClass}>access the Services; and</li>
            <li className={listItemClass}>
              download or print a copy of any portion of the Content to which you have
              properly gained access,
            </li>
          </ul>
          <p className={bodyClass}>solely for your internal business purpose.</p>
          <p className={bodyClass}>
          ...
          <h3 className={subheadingClass}>Your submissions and contributions</h3>
          <p className={bodyClass}>
            Please review this section and the &ldquo;
            <a href="#prohibited" className={linkClass}>
              PROHIBITED ACTIVITIES
            </a>
            &rdquo; section carefully prior to using our Services to understand the (a)
            rights you give us and (b) obligations you have when you post or upload any
            content through the Services.
          </p>
          <p className={bodyClass}>
            <strong className={bold}>Submissions:</strong> By directly sending us any
            question, comment, suggestion, idea, feedback, or other information about the
            Services (&ldquo;Submissions&rdquo;), you agree to assign to us all intellectual
          ...
          <p className={bodyClass}>
            <strong className={bold}>Contributions:</strong> The Services may invite you to
            ...
            information, or other material (&ldquo;Contributions&rdquo;). Any Submission
          ...
          <p className={bodyClass}>
            ...
            worldwide right, and license to: use, copy, reproduce, distribute, sell, resell,
            ...
            of, or incorporate into other works, your Contributions, and to sublicense the
          ...
          <p className={bodyClass}>
            <strong className={bold}>You are responsible for what you post or upload:</strong>{" "}
          ...
          <p className={bodyClass}>
            <strong className={bold}>We may remove or edit your Content:</strong> Although we
            have no obligation to monitor any Contributions, we shall have the right to
          ...
          <h3 className={subheadingClass}>Copyright infringement</h3>
          <p className={bodyClass}>
            ...
            own or control, please immediately refer to the &ldquo;
            <a href="#copyrightyes" className={linkClass}>
              COPYRIGHT INFRINGEMENTS
            </a>
            &rdquo; section below.
          </p>

          <h2 id="userreps" className={headingClass}>
          ...
          <h2 id="userreg" className={headingClass}>
            4. User Registration
          </h2>
          <p className={bodyClass}>
          ...
          <h2 id="purchases" className={headingClass}>
            5. Purchases and Payment
          </h2>
          <p className={bodyClass}>We accept the following forms of payment:</p>
          <ul className={listClass}>
            {paymentMethods.map((method) => (
              <li key={method} className={listItemClass}>
                {method}
              </li>
            ))}
          </ul>
          ...
          <h3 className={subheadingClass}>Billing and Renewal</h3>
          <p className={bodyClass}>
            ...
            cancel the applicable order. The length of your billing cycle will depend on the
            type of subscription plan you choose when you subscribed to the Services.
          </p>
          <h3 className={subheadingClass}>Cancellation</h3>
          <p className={bodyClass}>
          ...
          <h3 className={subheadingClass}>Fee Changes</h3>
          <p className={bodyClass}>
          ...
          <p className={bodyClass}>As a user of the Services, you agree not to:</p>
          <ul className={listClass}>
            {prohibited.map((item) => (
              <li key={item} className={listItemClass}>
                {item}
          ...
          <h2 id="ugc" className={headingClass}>
          ...
          <p className={bodyClass}>
            ...
            (collectively, &ldquo;Contributions&rdquo;). Contributions may be viewable by
          ...
          <h2 id="license" className={headingClass}>
          ...
          <h2 id="socialmedia" className={headingClass}>
            11. Social Media
          </h2>
          <p className={bodyClass}>
            ...
            a &ldquo;Third-Party Account&rdquo;) by either: (1) providing your Third-Party
            ...
            you have provided to and stored in your Third-Party Account (the &ldquo;Social
            Network Content&rdquo;) so that it is available on and through the Services via
            ...
            through your account on the Services. Please note that if a Third-Party Account
            ...
            responsible for any Social Network Content. You acknowledge and agree that we may
          ...
          <h2 id="thirdparty" className={headingClass}>
          ...
          <p className={bodyClass}>
            ...
            from third parties (&ldquo;Third-Party Content&rdquo;). Such Third-Party
            ...
            any Third-Party Websites accessed through the Services or any Third-Party Content
          ...
          <h2 id="advertisers" className={headingClass}>
            13. Advertisers
          </h2>
          <p className={bodyClass}>
          ...
          <h2 id="sitemanage" className={headingClass}>
          ...
          <p className={bodyClass}>
            ...
            States and Germany, then through your continued use of the Services, you are
            transferring your data to the United States and Germany, and you expressly
            consent to have your data transferred to and processed in the United States and
            Germany.
          </p>

          <h2 id="copyrightyes" className={headingClass}>
          ...
          <p className={bodyClass}>
            ...
            provided below (a &ldquo;Notification&rdquo;). A copy of your Notification will
          ...
          <h2 id="terms" className={headingClass}>
          ...
          <p className={bodyClass}>
            ...
            OF ANY REPRESENTATION, WARRANTY, OR COVENANT CONTAINED IN THESE LEGAL TERMS OR OF
          ...
          <h2 id="modifications" className={headingClass}>
          ...
          <p className={bodyClass}>
            ...
            claim related to these Legal Terms (each a &ldquo;Dispute&rdquo; and
            collectively, the &ldquo;Disputes&rdquo;) brought by either you or us
            (individually, a &ldquo;Party&rdquo; and collectively, the &ldquo;Parties&rdquo;),
          ...
          <p className={bodyClass}>
            ...
            the dispute shall be finally resolved by arbitration in accordance with the
            United Nations Commission on International Trade Law Arbitration Rules in force at
            the time of commencement of the arbitration. The number of arbitrators shall be
            one (1). The seat, or legal place, or arbitration shall be Kyiv, Ukraine. The
            language of the proceedings shall be English. The governing law of these Legal
            Terms shall be substantive law of Ukraine.
          </p>
          <h3 className={subheadingClass}>Restrictions</h3>
          <p className={bodyClass}>
          ...
          <p className={bodyClass}>
            ...
            and (c) any claim for injunctive relief. If this provision is found to be illegal
          ...
          <h2 id="corrections" className={headingClass}>
            21. Corrections
          </h2>
          <p className={bodyClass}>
          ...
          <h2 id="disclaimer" className={headingClass}>
            22. Disclaimer
          </h2>
          <p className={bodyClass}>
            ...
            COMPLETENESS OF THE SERVICES&rsquo; CONTENT OR THE CONTENT OF ANY WEBSITES OR
          ...
          <h2 id="indemnification" className={headingClass}>
            24. Indemnification
          </h2>
          <p className={bodyClass}>
            ...
            reasonable attorneys&rsquo; fees and expenses, made by any third party due to or
            arising out of: (1) your Contributions; (2) use of the Services; (3) breach of
          ...
          <h2 id="userdata" className={headingClass}>
            25. User Data
          </h2>
          <p className={bodyClass}>
            We will maintain certain data that you transmit to the Services for the purpose
            of managing the performance of the Services, as well as data relating to your use
          ...
          <h2 id="electronic" className={headingClass}>
          ...
          <h2 id="california" className={headingClass}>
          ...
          <h2 id="misc" className={headingClass}>
            28. Miscellaneous
          </h2>
          <p className={bodyClass}>
            ...
            agency relationship created between you and us as a result of these Legal Terms or
